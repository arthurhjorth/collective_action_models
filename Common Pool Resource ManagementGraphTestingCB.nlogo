extensions [table cf palette webview ] ;color-generator ]
...
globals [
  ...
  student-names tickValues reporterList  activeUsername datasetCount requestedDataSets
]
...
to add-student-named [ aname ]
  ...
  set activeUsername aname ;studentName
