...
to setup-world
  ...
  ask fences [die]
  ask edge-patches [
    sprout-fences 1 [set shape "fence" set heading 0 set color brown set durability 100]
    set grass 0
    set pcolor green
    ]
end
...
"" ""
PENS
"Grass                   " 1.0 0 -10899396 true "" "plotxy ticks sum [grass] of patches"
...
"" ""
PENS
"Cows                   " 1.0 0 -6459832 true "" "plotxy ticks count cows"
"Time Marker" 1.0 0 -7500403 true "" "let x-value plot-x-max * marker / 100\nplot-pen-reset\n    plot-pen-up\n    plotxy x-value plot-y-min\n    plot-pen-down\n    plotxy x-value plot-y-max"
"Time Stamp" 1.0 0 -2674135 true "" ""
...
"" ""
PENS
"Milk Production" 1.0 0 -5825686 true "" "plotxy ticks latest-milk-production"
"Time Marker" 1.0 0 -7500403 true "" "let x-value plot-x-max * marker / 100\nplot-pen-reset\n    plot-pen-up\n    plotxy x-value plot-y-min\n    plot-pen-down\n    plotxy x-value plot-y-max"
"Time Stamp" 1.0 0 -2674135 true "" ""
